...
BT buttons: [60x60mm Square Buttons](../../parts/buttons/60-60-sqaure-buttons.md)

FX buttons: [50x33mm Rectangle Buttons](../../parts/buttons/50-33-rectangle-buttons.md)

Start button: [33x33mm Square Buttons](../../parts/buttons/33-33-square-buttons.md)

## Knobs

Possible options for encoder are listed [here](../../parts/encoders.md).
